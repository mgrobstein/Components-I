...
function menuMaker (menuArr){
  ...
  menuArr.forEach(arg => {
    const arg2 = document.createElement('li');
    arg2.textContent = arg;
    menuUL.appendChild(arg2);
  });
  ...
  const headerThingy = document.querySelector('.header')
  headerThingy.appendChild(menuMaker(menuItems));
//   <div class="menu">
//     <ul>
